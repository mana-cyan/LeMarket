...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <ul id="nav-list" class="nav nav-tabs" role="tablist" style="border-bottom:1px solid #ccc;">
            <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">订单管理</a>
            </li>
            <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">收货地址</a>
            </li>
            <li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab">我的资料</a>
            </li>
            <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">我的店铺</a>
            </li>
            <li role="presentation"><a href="#shoucang" aria-controls="shoucang" role="tab" data-toggle="tab">我的收藏</a>
            </li>
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="home" style="margin-top:20px;">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#dfk" aria-controls="dfk" role="tab"
                                                              data-toggle="tab">购物车</a></li>
                    ...
                    <li role="presentation"><a href="#qbdd" aria-controls="qbdd" role="tab" data-toggle="tab">全部订单</a>
                    </li>
                </ul>
                ...
                <div class="tab-content" style="margin-top:20px;padding:20px;">
                    ...
                    <!-- 待收货 -->
                    <div role="tabpanel" class="tab-pane" id="dsh"></div>

                    <!-- 待评价 -->
                    <div role="tabpanel" class="tab-pane" id="dpj"></div>

                    <!-- 全部订单 -->
                    <div role="tabpanel" class="tab-pane" id="qbdd"></div>
                </div>
            </div>
                ...
                <div style="margin-top:30px;">
                    ...
                    <div style="margin-top:20px;border-bottom:1px solid #ccc;padding-bottom:20px;">
                        <table style="" class="shdz">
                            ...
                            <tr style="width:100%;">
                                <td>地址：</td>
                                <td colspan="2"><input id="new-address" type="text" class="form-control"
                                                       placeholder="详细地址"></td>
                            </tr>
                            <tr style="width:100%;">
                                <td>电话号码：</td>
                                <td colspan="2"><input id="new-phone" type="text" class="form-control"
                                                       placeholder="手机号"></td>
                            </tr>
                        </table>
                    </div>
                    <button type="button" class="btn btn-default" onclick="addAddress()"
                            style="width:20%;height:60%;margin:0 auto;margin-top:30px;background-color:#F10180;color:#fff;border-radius:5px;">
                        保存收货地址
                    </button>
                </div>
                ...
                <div style="margin-top:30px;">
                    ...
                    <div style="margin-top:20px; padding-bottom:20px; border-bottom:1px solid #ccc;">
                        <table style="" class="shdz">
                            ...
                            <tr style="width:100%;">
                                <td>地址：</td>
                                <td colspan="3"><input id="address" type="text" class="form-control" placeholder="详细地址">
                                </td>
                            </tr>
                            <tr style="width:100%;">
                                <td>身份证号：</td>
                                <td colspan="2"><input id="identityNumber" type="text" class="form-control"
                                                       placeholder="身份证号"></td>
                            </tr>
                            <tr style="width:100%;">
                                <td>电话号码：</td>
                                <td colspan="2"><input id="phoneNumber" type="text" class="form-control"
                                                       placeholder="手机号"></td>
                            </tr>
                        </table>
                    </div>
            ...
            <div role="tabpanel" class="tab-pane" id="shoucang" style="margin-top:20px;padding:20px;">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#scsp" aria-controls="scsp" role="tab"
                                                              data-toggle="tab">收藏商品</a></li>
                    <li role="presentation"><a href="#scdp" aria-controls="scdp" role="tab" data-toggle="tab">收藏店铺</a>
                    </li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="scsp">
                        <div class="row" style="border-top:1px solid #ccc;padding:10px;margin-top:25px;">
                            <div class="col-md-3">
                                <a href="commodityDetails"><img
                                        src="${pageContext.request.contextPath}/static/images/product/arrival/1.jpg"
                                        style="width:30%;height:40%;"></a>
                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="scdp">
                        <div class="row" style="border-top:1px solid #ccc;padding:10px;margin-top:30px;">
                            ...
                            <div class="col-md-3" style="margin-top:20px;padding:20px;">
                                <div class="btn-group" role="group" aria-label="...">
                                    <button type="button" class="btn btn-default"><a href="../shop/shop.jsp">去看看</a>
                                    </button>
                                    <button type="button" class="btn btn-default">删除订单</button>
                                </div>
                            </div>
